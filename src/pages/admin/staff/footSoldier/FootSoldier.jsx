  ...
  return (
    <div id={Style.Customer_Support_mainDiv}>
      <Header
        ...
        headerInfo={"Here’s an overview of Foot Soldiers activities"}
      />

      <div id={Style.Customer_Support_wrapperDiv}>
        <p id={Style.Customer_SupportText}>Foot Soldiers Summary</p>
