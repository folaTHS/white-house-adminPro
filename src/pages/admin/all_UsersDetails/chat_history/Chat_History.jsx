    ...
    <div id={Style.Chat_History_mainDiv}>
      ...
      <div id={Style.Chat_History_wrapperDiv}>
        ...
        <div id={Style.Chat_HistoryDiv}>
          ...
          <div id={window.innerWidth < 480 ? Style.ChatsDiv : null}>
            <div className={Style.Chat_History_contentDiv}>
              <img src={person} alt="" />
              <p className={Style.Chat_History_content}>
                Lorem ipsum dolor sit amet consectetur. olor sit amet
                consectetur.
              </p>
            </div>
          ...
          <div id={window.innerWidth < 480 ? Style.ChatsDiv : null}>
            <div className={Style.Chat_History_contentDiv}>
              <img src={person2} alt="" />
              <p className={Style.Chat_History_content_two}>
                Lorem ipsum dolor sit amet consectetur. olor sit amet
                consectetur.
              </p>
            </div>
